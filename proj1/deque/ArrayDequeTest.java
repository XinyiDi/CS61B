...
public class ArrayDequeTest {
    ...
    @Test
    /* check if correct item is returned when getTest() called. */
    public void getTest() {
        ...
        ad1.addFirst(2);
        ad1.addLast(3);
        assertEquals("Should return 2 when get(0) is called", Optional.of(2), ad1.get(0));
        assertEquals("Should return null when removeLast is called on an empty Deque,", null, ad1.removeLast());
    ...
    @Test //-- should be uncommented when resize() function is ready;
